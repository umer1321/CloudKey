...
class _BookingScreenState extends State<BookingScreen> {
  ...
  // Mock data with real Saudi Arabia hotel names
  final List<Map<String, dynamic>> mockHotels = [
    {
      'id': '1',
      'name': 'Ritz-Carlton Riyadh',
      'price': 350.00,
      'image': 'https://example.com/ritz-carlton-riyadh.jpg',
    },
    {
      'id': '2',
      'name': 'Four Seasons Hotel Riyadh',
      'price': 400.00,
      'image': 'https://example.com/four-seasons-riyadh.jpg',
    },
    {
      'id': '3',
      'name': 'Burj Al Rajhi Hotel',
      'price': 250.00,
      'image': 'https://example.com/burj-al-rajhi.jpg',
    },
    {
      'id': '4',
      'name': 'Kingdom Centre Tower Hotel',
      'price': 300.00,
      'image': 'https://example.com/kingdom-centre-tower.jpg',
    },
    {
      'id': '5',
      'name': 'Al Rajhi Grand Hotel',
      'price': 280.00,
      'image': 'https://example.com/al-rajhi-grand.jpg',
    },
  ];
  ...
  Future<void> _fetchHotels() async {
    ...
    try {
      // Using mock data with real Saudi hotel names
      ...
      setState(() {
        isLoading = false;
        hotels = mockHotels;
        errorMessage = 'Failed to fetch hotels for $city: $e. Using mock data.';
      });
  ...
  Future<void> _createBooking() async {
    ...
    try {
      ...
      // Navigate to PaymentScreen instead of directly to BookingConfirmationScreen
      Navigator.pushNamed(
        context,
        Routes.payment,
        arguments: {
